...
theory_systematics = [
                ...
                {'name':'BR_hzg','title':'BR_hzg','type':'constant','prior':'lnN','correlateAcrossYears':1,'value':"0.943/1.057"},
                ...
                {'name':'pdf_Higgs_gg','title':'pdf_Higgs_gg','type':'constant','prior':'lnN','correlateAcrossYears':1,'value':'theory_uncertainties/thu_ggh.json'},
                {'name':'pdf_Higgs_qqbar','title':'pdf_Higgs_qqbar','type':'constant','prior':'lnN','correlateAcrossYears':1,'value':'theory_uncertainties/thu_qqh.json'},
...
experimental_systematics = [
                ...
                {'name':'weight_pu_reweight_sf_','title':'CMS_hzg_PileupWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_L1_prefiring_sf_','title':'CMS_hzg_L1_Prefiring','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_electron_veto_sf_Photon_','title':'CMS_hzg_ElectronVetoSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_electron_wplid_sf_SelectedElectron_','title':'CMS_hzg_Electron_WP','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_muon_looseid_sf_SelectedMuon_','title':'CMS_hzg_Muon_WP','type':'factory','prior':'lnN','correlateAcrossYears':1},
                ...
                # {'name':'jec_syst_Total','title':'CMS_scale_j','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # {'name':'jer_syst','title':'CMS_res_j','type':'factory','prior':'lnN','correlateAcrossYears':0},
                ...
                {'name':'METJes','title':'CMS_scale_MET','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'METUnclustered','title':'CMS_res_MET','type':'factory','prior':'lnN','correlateAcrossYears':0},
...
signal_shape_systematics = [
                ...
                {'name':'FNUF','title':'FNUF','type':'signal_shape','mode':'scalesCorr','mean':'0.0','sigma':'1.0'},
                {'name':'Material','title':'Material','type':'signal_shape','mode':'scalesCorr','mean':'0.0','sigma':'1.0'},
                {'name': "MuonPt", 'title':'MuonPt' , 'type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0'},
