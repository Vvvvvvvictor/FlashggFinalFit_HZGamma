...
globalXSBRMap['fiducialAnalysis'] = od()
globalXSBRMap['fiducialAnalysis']['decay'] = {'mode':"hgg"}
globalXSBRMap['fiducialAnalysis']['GG2H_in'] = {'mode':'constant','factor':51.96}
globalXSBRMap['fiducialAnalysis']['VBF_in'] = {'mode':'constant','factor':4.067}
globalXSBRMap['fiducialAnalysis']['VH_in'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['fiducialAnalysis']['TTH_in'] = {'mode':'constant','factor':0.5638}
globalXSBRMap['fiducialAnalysis']['GG2H_out'] = {'mode':'constant','factor':51.96}
globalXSBRMap['fiducialAnalysis']['VBF_out'] = {'mode':'constant','factor':4.067}
globalXSBRMap['fiducialAnalysis']['VH_out'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['fiducialAnalysis']['TTH_out'] = {'mode':'constant','factor':0.5638}
# globalXSBRMap['fiducialAnalysis']['ggH'] = {'mode':'constant','factor': 48.58}
# globalXSBRMap['fiducialAnalysis']['VBF'] = {'mode':'constant','factor': 3.782}
# globalXSBRMap['fiducialAnalysis']['WplusH'] = {'mode':'constant','factor': 0.8400}
# globalXSBRMap['fiducialAnalysis']['WminusH'] = {'mode':'constant','factor': 0.5328}
# globalXSBRMap['fiducialAnalysis']['ZH'] = {'mode':'constant','factor': 0.8839}
...
globalXSBRMap['differentialAnalysis']['GG2H_in_0jets'] = {'mode':'constant','factor':51.96}
globalXSBRMap['differentialAnalysis']['VBF_in_0jets'] = {'mode':'constant','factor':4.067}
globalXSBRMap['differentialAnalysis']['VH_in_0jets'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['differentialAnalysis']['TTH_in_0jets'] = {'mode':'constant','factor':0.5638}
globalXSBRMap['differentialAnalysis']['GG2H_in_1jets'] = {'mode':'constant','factor':51.96}
globalXSBRMap['differentialAnalysis']['VBF_in_1jets'] = {'mode':'constant','factor':4.067}
globalXSBRMap['differentialAnalysis']['VH_in_1jets'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['differentialAnalysis']['TTH_in_1jets'] = {'mode':'constant','factor':0.5638}
globalXSBRMap['differentialAnalysis']['GG2H_in_2jets'] = {'mode':'constant','factor':51.96}
globalXSBRMap['differentialAnalysis']['VBF_in_2jets'] = {'mode':'constant','factor':4.067}
globalXSBRMap['differentialAnalysis']['VH_in_2jets'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['differentialAnalysis']['TTH_in_2jets'] = {'mode':'constant','factor':0.5638}
globalXSBRMap['differentialAnalysis']['GG2H_in_3jets'] = {'mode':'constant','factor':51.96}
globalXSBRMap['differentialAnalysis']['VBF_in_3jets'] = {'mode':'constant','factor':4.067}
globalXSBRMap['differentialAnalysis']['VH_in_3jets'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['differentialAnalysis']['TTH_in_3jets'] = {'mode':'constant','factor':0.5638}
globalXSBRMap['differentialAnalysis']['GG2H_out'] = {'mode':'constant','factor':51.96}
globalXSBRMap['differentialAnalysis']['VBF_out'] = {'mode':'constant','factor':4.067}
globalXSBRMap['differentialAnalysis']['VH_out'] = {'mode':'constant','factor':2.3781}
globalXSBRMap['differentialAnalysis']['TTH_out'] = {'mode':'constant','factor':0.5638}