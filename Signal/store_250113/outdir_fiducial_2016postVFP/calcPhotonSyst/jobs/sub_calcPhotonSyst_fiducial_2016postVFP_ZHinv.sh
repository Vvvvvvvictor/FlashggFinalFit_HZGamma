...
python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat ZHinv --procs VBF,WminusH,WplusH,ZH,ggH,ttH --ext fiducial_2016postVFP --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2016postVFP --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' 
