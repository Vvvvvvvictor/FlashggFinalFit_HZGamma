...
python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/fTest.py --cat ttHh --procs VBF,WminusH,WplusH,ZH,ggH,ttH --ext fiducial_2016preVFP --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2016preVFP --doPlots
