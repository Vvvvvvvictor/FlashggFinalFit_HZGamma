...
python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/signalFit.py --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2016preVFP --ext fiducial_2016preVFP --proc VBF --cat ggH0 --year 2016preVFP --analysis fiducialAnalysis --massPoints 120,125,130 --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' --doPlots --beamspotWidthData 3.5 --beamspotWidthMC 3.7

python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/signalFit.py --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2016preVFP --ext fiducial_2016preVFP --proc WminusH --cat ggH0 --year 2016preVFP --analysis fiducialAnalysis --massPoints 120,125,130 --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' --doPlots --beamspotWidthData 3.5 --beamspotWidthMC 3.7

python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/signalFit.py --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2016preVFP --ext fiducial_2016preVFP --proc WplusH --cat ggH0 --year 2016preVFP --analysis fiducialAnalysis --massPoints 120,125,130 --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' --doPlots --beamspotWidthData 3.5 --beamspotWidthMC 3.7
