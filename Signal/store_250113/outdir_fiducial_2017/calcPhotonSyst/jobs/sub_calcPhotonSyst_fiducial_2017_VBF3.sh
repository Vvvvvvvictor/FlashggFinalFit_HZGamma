...
python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat VBF3 --procs VBF,WminusH,WplusH,ZH,ggH,ttH --ext fiducial_2017 --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2017 --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' 
