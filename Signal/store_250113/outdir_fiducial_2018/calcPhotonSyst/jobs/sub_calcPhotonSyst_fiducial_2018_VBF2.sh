...
python /eos/home-j/jiehan/finalfit_102X/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat VBF2 --procs VBF,WminusH,WplusH,ZH,ggH,ttH --ext fiducial_2018 --inputWSDir /eos/home-j/jiehan/root/input_finalfit/signal_2018 --scales 'Scale,MuonPt' --scalesCorr 'Material,FNUF' --scalesGlobal '' --smears 'Smearing' 
