...
backgroundScriptCfg = {
  ...
  'inputWS':'/eos/user/m/mingtao/workspace/zgamma/CMSSW_10_2_13/src/FlashggFinalFit_HZGamma/Inputdata/input_final/background/ws/output_Data_all.root', # location of 'output_Data_Run2.root' file
  ...
  'cats':'VBF0,VBF1,VBF2,VBF3', # auto: automatically inferred from input ws
  'catOffset':0, # add offset to category numbers (useful for categories from different allData.root files)  
  ## 'jiehan' 'rzou_run3' 'final'
  'ext':'final_syst', # extension to add to output directory (e.g. final, new)
