...
cwd__ = os.environ['CMSSW_BASE']+"/src/FlashggFinalFit_HZGamma"
...
# lumiMap = {'2016preVFP':16.80 , '2016postVFP': 19.51, '2017':41.48, '2018':59.83, 'combined':137.65, 'merged':137.65, '2022':34.7, '2022preEE':7.98, '2022postEE':26.67, '2023preBPix':17.79, '2023postBPix':9.45}
lumiMap = {'2016preVFP':1 , '2016postVFP': 1, '2016': 1, '2017':1, '2018':1, 'combined':1, 'merged':1, '2022':1, '2022preEE':1, '2022postEE':1,'2023preBPix':1, '2023postBPix':1, 'all':1}
